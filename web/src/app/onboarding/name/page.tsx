...
export default function NamePage() {
  ...
  return (
    <OnboardingShell
      step={1}
      title={t('onboarding.whatsFirstName')}
      subtitle={t('onboarding.nameAppearance')}
      canContinue={isValid}
      ...
      <div className="mt-4">
        ...
        <div className="flex justify-between mt-2">
          <p className="text-xs text-textLight">
            {t('onboarding.onlyFirstNameVisible')}
          </p>
        ...
        <div className="mt-6 relative">
          <div className="flex items-center justify-between gap-4 p-4 pr-16 bg-rose/5 border border-rose/10 rounded-2xl">
            <div>
              <p className="text-sm font-semibold text-charcoal">{t('onboarding.notSindhi')}</p>
              <p className="text-xs text-textLight mt-0.5">{t('onboarding.openToVibing')}</p>
            </div>
          </div>
          <div
